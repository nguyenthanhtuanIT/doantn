...
<html>
	...
	<body>
		...
		<div id="page">
			...
			<aside id="colorlib-hero">
				<div class="flexslider">
					<ul class="slides">
						<li style="background-image: url(upload/cr.jpg);">
			...
			<div id="colorlib-project">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6 animate-box">
							<div class="item item-2">
								<a href="images/building-2.jpg" class="project image-popup-link" style="background-image: url(upload/aboutme.jpeg);">
									<div class="desc-t">
										<div class="desc-tc">
											<div class="desc">
		...
		<!-- Stellar Parallax -->
		<script src="UI_asset/js/jquery.stellar.min.js"></script>
		<!-- Flexslider -->
		...
		<!-- Counters -->
		<script src="UI_asset/js/jquery.countTo.js"></script>
		<!-- Main -->
