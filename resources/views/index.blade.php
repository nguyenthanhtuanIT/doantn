								...
								<div class="row">
									<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
										<div class="slider-text-inner">
											<div class="desc">
												<h1><span class="text-center"><small>{{$sl->id}}</small></span> Top 10 Places To Start Your Vacation This Summer</h1>
											</div>
										</div>
									</div>
								</div>
							...
							<article class="blog-flex">
								...
								<div class="half">
									<div class="desc">
										...
										<p class="first-letra mar"><strong>Time start: </strong>{{$t->time_start}}</p>
										<p class="first-letra mar"><strong>Time end: </strong>{{$t->time_end}}</p>
										<p class="first-letra mar"><strong>Amount: </strong>{{$t->amount}}</p>
										<p class="first-letra mar" id="status"><strong>Status: </strong>{{$t->status}}</p>
										<p class="first-letra mar"><strong>Descript: </strong>{{$t->description}}</p>
										...
										<div class="a">
											...
											id="books">Books </a></p>
											@endif
											<p class="btnbook"><a href="blog/{{$t->id}}" class="btn btn-primary btn-custom  btndetail">Detail </a>
										</p>
									</div>
								</div>
							</div>
